-- ============================================================================
-- HTML Code Editor - 完整数据库初始化脚本 (生产就绪版)
-- ============================================================================
-- 版本: v3.1
-- 日期: 2026-05-18
-- 适用: MySQL 5.7+ / MySQL 8.x / MariaDB 10.3+
-- 特性: 幂等可重复执行、完整表结构、索引、视图、默认配置
...
-- ============================================================================
-- 第二步: 数据表 (全部使用 IF NOT EXISTS 保证幂等)
-- ============================================================================
...
-- ============================================================================
-- 第三步: 插入默认系统配置 (使用 INSERT IGNORE 保证幂等)
-- ============================================================================
...
-- ============================================================================
-- 第四步: 创建视图 (使用 CREATE OR REPLACE 保证幂等)
-- ============================================================================
...
-- ============================================================================
-- 第六步: 创建事件调度器 (MySQL 8.x / MariaDB 10.3+)
-- ============================================================================
