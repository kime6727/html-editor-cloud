...
| **目标服务器** | https://html.niceapp.eu.cc |
| **服务器环境** | PHP + MySQL |
...
- ✅ 部署完成后即可通过 https://html.niceapp.eu.cc 验证
...
# 4. 访问已发布页面
curl -I https://html.niceapp.eu.cc/pub/{project_id}/index.html
```
...
```swift
static let baseURL = "https://html.niceapp.eu.cc"
```
...
- 网络是否能访问 `https://html.niceapp.eu.cc`
...
2. ✅ iOS 应用发布成功并返回 URL
3. ✅ 返回 URL 格式：`https://html.niceapp.eu.cc/pub/{project_id}/index.html`
